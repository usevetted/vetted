      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 top-0 bottom-0 w-[85vw] max-w-[340px] bg-white z-[100] flex flex-col rounded-r-2xl shadow-xl"
          >
            {/* Header */}
                                ...
                                <div key={i} className="flex items-center justify-between py-2">
                                  ...
                                  {opt.toggle ? (
                                    <button
                                      ...
                                      className={`w-10 h-6 rounded-full transition-colors relative flex-shrink-0 ${opt.value ? 'bg-primary' : 'bg-muted-foreground/30'}`}
                                    >
                                      <div className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-transform ${opt.value ? 'translate-x-4.5' : 'translate-x-0.5'}`} />
                                    </button>
                                  ) : (
                                  ...
                                  {opt.action === 'changePassword' && (
                                    <>
                                      <button
                                        ...
                                        className="text-[13px] text-foreground/70 py-2 hover:text-primary transition-colors"
                                      >
                                        {opt.label}
                                      </button>
                                      {showChangePassword && (
