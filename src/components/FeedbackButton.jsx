  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 right-4 z-40 w-11 h-11 bg-card border border-border/50 shadow-lg rounded-full flex items-center justify-center hover:bg-muted transition-colors"
      >
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 bg-card rounded-t-3xl p-6 pb-8 z-50 shadow-2xl"
            >
              <div className="w-10 h-1 bg-muted rounded-full mx-auto mb-5" />
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-[16px] font-semibold text-foreground">Send Feedback</h3>
                <button onClick={() => setOpen(false)} className="w-9 h-9 rounded-full flex items-center justify-center hover:bg-muted transition-colors">
