      ...
      <div className="px-4 pt-2 pb-6 border-t border-border/50 bg-background">
        <div className="flex items-center gap-2.5">
          <input
            ...
            className="flex-1 h-[40px] border border-input rounded-full px-4 text-[13px] bg-card focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
          />
          <button
            onClick={handleSend}
